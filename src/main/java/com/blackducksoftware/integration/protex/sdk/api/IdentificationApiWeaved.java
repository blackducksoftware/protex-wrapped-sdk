...
public class IdentificationApiWeaved extends WeavedApi<IdentificationApi> implements IdentificationApi {
	...
	@Override
	public void addCodeMatchExclusion(final String arg0,
			final String arg1,
			final CodeMatchExclusionRequest arg2,
			final BomRefreshMode arg3) throws SdkFault {
		getApi().addCodeMatchExclusion(arg0, arg1, arg2, arg3);
	}

	@Override
	public void addCodeMatchIdentification(final String arg0,
			final String arg1,
			final CodeMatchIdentificationRequest arg2,
			final BomRefreshMode arg3) throws SdkFault {
		getApi().addCodeMatchIdentification(arg0, arg1, arg2, arg3);
	}

	@Override
	public void addDependencyIdentification(final String arg0,
			final String arg1,
			final DependencyIdentificationRequest arg2,
			final BomRefreshMode arg3) throws SdkFault {
		getApi().addDependencyIdentification(arg0, arg1, arg2, arg3);
	}

	@Override
	public void addStringSearchIdentification(final String arg0,
			final String arg1,
			final StringSearchIdentificationRequest arg2,
			final BomRefreshMode arg3) throws SdkFault {
		getApi().addStringSearchIdentification(arg0, arg1, arg2, arg3);
	}

	@Override
	public void copyIdentifications(final String arg0,
			final String arg1, final String arg2,
			final String arg3, final Boolean arg4,
			final Boolean arg5, final BomRefreshMode arg6)
					throws SdkFault {
		getApi().copyIdentifications(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
	}

	@Override
	public List<AuditedEvent> getAuditTrail(final String arg0,
			final Date arg1, final Date arg2) throws SdkFault {

		return getApi().getAuditTrail(arg0, arg1, arg2);
	}

	@Override
	public String getIdentifyBomURL(final String arg0,
	...
	@Override
	public String getIdentifyCodeMatchesURL(final String arg0,
			final String arg1) throws SdkFault {
	...
	@Override
	public String getIdentifyDependenciesURL(final String arg0,
			final String arg1) throws SdkFault {
	...
	@Override
	public String getIdentifyStringSearchesURL(final String arg0,
			final String arg1) throws SdkFault {
	...
	@Override
	public Long learnIdentification(final String arg0,
			final Identification arg1) throws SdkFault {

		return getApi().learnIdentification(arg0, arg1);
	}

	@Override
	public void removeCodeMatchExclusion(final String arg0,
			final CodeMatchExclusion arg1,
			final BomRefreshMode arg2) throws SdkFault {
		getApi().removeCodeMatchExclusion(arg0, arg1, arg2);
	}

	@Override
	public void removeCodeMatchIdentification(final String arg0,
			final CodeMatchIdentification arg1,
			final BomRefreshMode arg2) throws SdkFault {
		getApi().removeCodeMatchIdentification(arg0, arg1, arg2);
	}

	@Override
	public void removeDeclaredIdentification(final String arg0,
			final DeclaredIdentification arg1,
			final BomRefreshMode arg2) throws SdkFault {
		getApi().removeDeclaredIdentification(arg0, arg1, arg2);
	}

	@Override
	public void removeDependencyIdentification(final String arg0,
			final DependencyIdentification arg1,
			final BomRefreshMode arg2) throws SdkFault {
		getApi().removeDependencyIdentification(arg0, arg1, arg2);
	}

	@Override
	public void removeStringSearchIdentification(final String arg0,
			final StringSearchIdentification arg1,
			final BomRefreshMode arg2) throws SdkFault {
		getApi().removeStringSearchIdentification(arg0, arg1, arg2);
	}

	@Override
	public void runRapidId(final String arg0, final String arg1,
			final RapidIdentificationRefreshMode arg2) throws SdkFault {
	...
	@Override
	public void reevaluateRapidIDMatches(final String arg0, final String arg1,
			final RapidIdentificationRefreshMode arg2) throws SdkFault {
