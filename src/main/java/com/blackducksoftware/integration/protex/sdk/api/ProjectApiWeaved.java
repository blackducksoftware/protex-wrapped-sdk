...
public class ProjectApiWeaved extends WeavedApi<ProjectApi> implements ProjectApi {
	...
	@Override
	public String addFileDiscoveryPattern(final String arg0,
			final FileDiscoveryPatternRequest arg1) throws SdkFault {
		return getApi().addFileDiscoveryPattern(arg0, arg1);
	}

	@Override
	public String addProjectObligation(final String arg0,
			final AssignedObligationRequest arg1) throws SdkFault {
		return getApi().addProjectObligation(arg0, arg1);
	}

	@Override
	public String addProjectObligationUsingReference(final String arg0,
			final String arg1, final Boolean arg2,
			final Boolean arg3) throws SdkFault {
		return getApi().addProjectObligationUsingReference(arg0, arg1, arg2, arg3);
	}

	@Override
	public void addProjectUser(final String arg0, final String arg1)
			throws SdkFault {
		getApi().addProjectUser(arg0, arg1);
	}

	@Override
	public Long addRapidIdConfiguration(final String arg0,
			final RapidIdConfigurationRequest arg1) throws SdkFault {

		return getApi().addRapidIdConfiguration(arg0, arg1);
	}

	@Override
	public String addStringSearchPattern(final String arg0,
			final StringSearchPatternRequest arg1) throws SdkFault {

		return getApi().addStringSearchPattern(arg0, arg1);
	}

	@Override
	public void associateRapidIdConfiguration(final String arg0,
			final String arg1,
			final Long arg2) throws SdkFault {
	...
	@Override
	public String createProject(final ProjectRequest arg0,
			final LicenseCategory arg1) throws SdkFault {
	...
	@Override
	public void dissociateRapidIdConfiguration(final String arg0,
			final String arg1,
			final Long arg2) throws SdkFault {
	...
	@Override
	public FileDiscoveryPattern getFileDiscoveryPatternById(final String arg0,
	...
	@Override
	public List<FileDiscoveryPattern> getFileDiscoveryPatterns(final String arg0,
			final List<PatternOriginType> arg1,
			final FileDiscoveryPatternPageFilter arg2) throws SdkFault {

		return getApi().getFileDiscoveryPatterns(arg0, arg1, arg2);
	}

	@Override
	public License getLicenseById(final String arg0,
			final String arg1) throws SdkFault {
	...
	@Override
	public List<AssignedObligation> getProjectObligations(final String arg0,
			final AssignedObligationPageFilter arg1) throws SdkFault {
	...
	@Override
	public List<String> getRapidIdConfigurationAssociations(final String arg0,
			final Long arg1) throws SdkFault {

		return getApi().getRapidIdConfigurationAssociations(arg0, arg1);
	}

	@Override
	public RapidIdConfiguration getRapidIdConfigurationById(final String arg0,
			final Long arg1) throws SdkFault {
	...
	@Override
	public RapidIdConfiguration getRapidIdConfigurationByName(final String arg0,
			final String arg1) throws SdkFault {
	...
	@Override
	public StringSearchPattern getStringSearchPatternById(final String arg0,
			final String arg1) throws SdkFault {
	...
	@Override
	public StringSearchPattern getStringSearchPatternByName(final String arg0,
			final String arg1) throws SdkFault {
	...
	@Override
	public void removeFileDiscoveryPattern(final String arg0,
			final String arg1) throws SdkFault {
		getApi().removeFileDiscoveryPattern(arg0, arg1);
	}

	@Override
	public void removeProjectObligation(final String arg0,
			final String arg1) throws SdkFault {
		getApi().removeProjectObligation(arg0, arg1);
	}

	@Override
	public void removeProjectUser(final String arg0, final String arg1)
			throws SdkFault {
		getApi().removeProjectUser(arg0, arg1);
	}

	@Override
	public void removeRapidIdConfiguration(final String arg0,
			final Long arg1) throws SdkFault {
		getApi().removeRapidIdConfiguration(arg0, arg1);
	}

	@Override
	public void removeStringSearchPattern(final String arg0,
			final String arg1) throws SdkFault {
		getApi().removeStringSearchPattern(arg0, arg1);
	}

	@Override
	public void resetFileDiscoveryPattern(final String arg0,
			final String arg1) throws SdkFault {
		getApi().resetFileDiscoveryPattern(arg0, arg1);
	}

	@Override
	public void startAnalysis(final String arg0,
			final Boolean arg1) throws SdkFault {
		getApi().startAnalysis(arg0, arg1);
	}

	@Override
	public List<ProjectInfo> suggestProjects(final String arg0,
			final ProjectInfoPageFilter arg1) throws SdkFault {

		return getApi().suggestProjects(arg0, arg1);
	}

	@Override
	public void updateAnalysisDatabaseOptions(final String arg0,
			final AnalysisDatabaseOptions arg1) throws SdkFault {
		getApi().updateAnalysisDatabaseOptions(arg0, arg1);
	}

	@Override
	public void updateCaptureOptions(final String arg0,
			final CaptureOptions arg1) throws SdkFault {
		getApi().updateCaptureOptions(arg0, arg1);
	}

	@Override
	public void updateCodeLabelOption(final String arg0,
			final CodeLabelOption arg1) throws SdkFault {
		getApi().updateCodeLabelOption(arg0, arg1);
	}

	@Override
	public void updateRapidIdentificationMode(final String arg0,
			final RapidIdentificationMode arg1) throws SdkFault {
